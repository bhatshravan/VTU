...
while ccurl<=ccend:
	...
	ucc="1KS"
	text_file = open("16Sem3.txt", "a")
		
	if(cdone=="done" or skip>5):
		print("\nGoing to next college")
		text_file.close()
		text_file = open("16Sem3.txt.txt", "a")
	...
	#Get VTU URL
		...
		print(ultusn)
		try:
			response =requests.post('http://results.vtu.ac.in/vitaviresultcbcs/resultpage.php', data={'usn':ultusn}, timeout=15)
